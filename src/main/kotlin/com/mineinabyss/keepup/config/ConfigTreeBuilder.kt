...
//        return (root / deleteUnder).walk(PathWalkOption.INCLUDE_DIRECTORIES)
//            .filter { it.isRegularFile() }
//            .filter { path ->
//                val relativePath = path.relativeTo(root).pathString
//                relativePath !in tracked && relativePath !in path / config.keep
//            }
    }
}
